...
% Title page
\title[Quadrature-Free LDG]{Introduction of master
  thesis:\\[.8em]Quadrature-Free Implementation of the Local Discontinuous
  Garlerkin Method}
\author{Christopher Bross}
\date[2017-02-09]{Erlangen, 2017-02-09}
\institute[AM1]{Applied Mathematics I}
...
% % SYSTEM OF EQUATIONS
\only<4>{
  \tikzoverlay (system) at (-11.43cm, 0cm) {%
...
%TODO schleifen variante
%TODO vielleicht auch M
\begin{frame}
  \frametitle{Assembly of $\vecc{G^m}$}
%TODO phi's einführen
